...
(function () {
    ...
    chrome.storage.local.get(
        ["floatingButtonVisible", "floatingButtonTop"],
        (data) => {
            ...
            const openPopupBtn =
                floatingContainer.querySelector("#open-popup-btn");
            ...
            function onMouseMove(e) {
                ...
                const maxY =
                    window.innerHeight - floatingContainer.offsetHeight;
            ...
            fillBtn.addEventListener("click", async () => {
                ...
                mainIcon.innerHTML =
                    '<div class="autofill-floating-spinner"></div>';
                try {
